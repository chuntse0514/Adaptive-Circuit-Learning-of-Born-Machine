...
class TensorNetwork:
    ...
    def __init__(self, 
        ...
        self.filename = f'./images/MPS/MPS(data={data_class.name}, lr={lr}, reps={reps}).png'
        self.result_file = f'./results/MPS/MPS(data={data_class.name}, lr={lr}, reps={reps}).json'
...
if __name__ == "__main__":
    ...
    TN = TensorNetwork(
        data_class=DATA_HUB['real image 2 (R)'],
        n_epoch=8000,
        reps=3,
        lr=0.01
    )
