...
class ACLBM:
    ...
    def fit(self):
        ...
        for i_iter in range(self.n_iter):
            ...
            # max_grad, selected_index, selected_gate = self.select_operator()
            ...
            self.operatorID += selected_index
            ...
            if i_iter == 0:
                opt = optim.Adam(self.params.values(), lr=lr, betas=(0.7, 0.999))
        ...
        # answer = input("Training complete. Do you want to save the model? (yes/no): ").lower()
